export namespace main {
	...
	export class AppSettings {
	    ...
	    customFormats: parser.CustomFormat[];
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.customFormats = this.convertValues(source["customFormats"], parser.CustomFormat);
	    }
	...
	export class TestFormatResult {
	    success: boolean;
	    error: string;
	    entry?: parser.LogEntry;
	
	    static createFrom(source: any = {}) {
	        return new TestFormatResult(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.success = source["success"];
	        this.error = source["error"];
	        this.entry = this.convertValues(source["entry"], parser.LogEntry);
	    }
